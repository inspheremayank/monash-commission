            ...
            <div class="col-12">
                <div class="page__body--wrapper">
                    <div class="card-wrap">
                                ...
                                <div class="social twitter video">
                                    <a href="javascript:;" class="card__view--items">
                                        <figure class="embed-responsive embed-responsive-16by9 flex-last">
                                            <img src="static/images/image1.jpg" alt="image" class="embed-responsive-item" />
                                        ...
                                        <div class="card__view--content flex-first">
                                            <div class="content__section">
                                                ...
                                                <div class="content__section--category upper">Finance</div>
                                                <div class="content__section__head">
                                                    <div class="content__section__head--heading">How the West got China wrong</div>
                                                    <div class="content__section__head--image">
                                                        <figure class="image-covered" style="background-image: url('static/images/image1.jpg')"></figure>
                                                        <div class="video-play"></div>
                                                    </div>
                                                </div>
                                                <div class="content__section--description text__dotdot">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</div>
                                                <div class="content__section-userInfo"> 
                                                    <div class="content__section-userInfo-image image-covered" style="background-image: url('static/images/icons/avatar.png')"></div> 
                                                    <div class="content__section-userInfo-content"> 
                                                        <span class="title">Rebekah Brown</span> 
                        ...
                        <div class="row">
                            <div class="card__view col-12 col-md-6 col-lg-4 card__view-third">
                                    ...
                                    <a href="javascript:;" class="card__view--items">
                                        ...
                                        <div class="card__view--content flex-first">
                                            <div class="content__section">
                                                ...
                                                <div class="content__section--category upper">Finance</div>
                                                <div class="content__section__head">
                                                    <div class="content__section__head--heading">A lose-lose trade war looms between America and China, and everyone suffers A lose-lose trade war looms between America and China, and everyone suffers A lose-lose trade war looms between America and China, and everyone suffers</div>
                                                    <div class="content__section__head--image">
                                                        <figure class="image-covered" style="background-image: url('static/images/image1.jpg')"></figure>
                                                        <div class="video-play"></div>
                                                    </div>
